...
const STATS = [
  ...
  { value: 544, suffix: '+', label: 'GitHub\nContributions',    static: false },
  { value: 0,   suffix: '',  label: 'Azure AI\nCertified',      static: true, display: 'AI-900' },
]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <span style={{ color: 'var(--accent)' }}>run in the real world.</span>
            </motion.h1>
            ...
            >
              {STATS.map(({ value, suffix, label, static: isStatic, display }) => (
          ...
          >
            ...
            >
              {/* Replace src with actual photo when ready */}
              <Image
